...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_path', default="../exp/ctdet/infrared_point_res34_384/logs_2023-08-17-22-32/model_last.pth", type=str, help='')
    parser.add_argument('--dataset_path', default="../data/PSF0815_6_IR_30/", type=str, help='')

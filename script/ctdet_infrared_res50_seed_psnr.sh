...
python main.py ctdet --exp_id seed_res50_all --arch res_50 --dataset point --mse_loss \
                     ...
                     --commit "train all data [train_val_30_seed] with resnet50 psnr=10 20 40, without noise" \
...
python main.py ctdet --exp_id seed_res50_all --arch res_50 --dataset point --mse_loss \
                     ...
                     --commit "train all data [train_val_60_seed] with resnet50 psnr=10 20 40, without noise" \

...
python main.py ctdet --exp_id seed_res50_psf_1110 --arch res_50 --dataset point --mse_loss \
                    ...
                    --dataset_path ../data/train_val_1110_init.json  --data_mode all  --psnr 0 10 20 30 40 \
                    --commit "scratch from imagenet, train all data [train_val_1110_init] with resnet50 psnr=[0 40], without noise" \
                    --load_model ../exp/ctdet/seed_res50_psf_1110/logs_2023-11-10-11-35-39/model_epoch_30.pth
